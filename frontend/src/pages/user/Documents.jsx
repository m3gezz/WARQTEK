...
export default function Documents() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await Client.get(`/api/documents?page=${page}`, {
        headers: {
  ...
  return (
    <main className="w-[90%] mx-auto max-w-300 border-4 select-none rounded-2xl mt-10 py-10 border-warqtek">
      <h1 className="text-center mb-10 text-4xl">Track your requests</h1>
      <Table className="border-separate border-spacing-x-2 border-spacing-y-2">
        <TableCaption>A list of your recent document requests.</TableCaption>
        <TableHeader>
          <TableRow>
      ...
      <div className="flex justify-between pt-4 items-center px-10 w-[90%] mx-auto">
        <Button
